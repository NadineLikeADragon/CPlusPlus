// Forgetful Binary Search.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
#include <iostream>
#include <string>
#include "ForgetfulBinarySearch.h"
#include "ForgetfulBinarySearch.cpp"
using namespace std;
...
int main()
{
    ...
    do {
        ...
        ForgetfulBinarySearch<int> forgetfulBinarysearch;
        forgetfulBinarysearch.forgetfulBinarySearch(values, MAX_ITEMS ,item, found, count);
